...
public class InitializerTest {
  ...
  public void setUp() throws Exception {
    ...
    Mockito.when(controllerAccess.getControllerId()).thenReturn("ess.common");
  ...
  private File createLog4jFile() throws IOException {
    ...
    File log4jFile =
        new File(tmpFile.getParentFile(), "temp_unit_test/conf/log4j2.ess.common.properties");
    tmpFile.delete();
    log4jFile.getParentFile().mkdirs();
    FileWriter fw = new FileWriter(log4jFile);
    try {
      fw.write(LOG4J_CONFIG);
    } finally {
      fw.close();
    }
    return log4jFile;
