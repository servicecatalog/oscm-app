...
/** @author worf */
public class AzureServer implements ServerInformation {

  /** */
  private static final long serialVersionUID = 1205112057326L;
  ...
  /** @param floatingIP the floatingIP to set */
  @Override
  ...
  public String getPrivateIPasString() {
    ...
    for (Iterator<String> iterator = fixedIP.iterator(); iterator.hasNext(); ) {
  ...
  public String getPublicIPasString() {
    ...
    StringBuilder sb = new StringBuilder();
    for (Iterator<String> iterator = floatingIP.iterator(); iterator.hasNext(); ) {
      String ip = iterator.next();
      sb.append(ip);
      if (iterator.hasNext()) {
        sb.append("\n");
